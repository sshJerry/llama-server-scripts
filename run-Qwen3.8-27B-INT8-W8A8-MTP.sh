#!/bin/bash
# vLLM 0.29.0 — Freaksterz/Qwen3.8-27B-SmoothQuant-W8A8-INT8 (v3), 2x RTX 3090 TP=2
...
/opt/vllm29/bin/vllm serve /models/Models/Freaksterz/Qwen3.8-27B-SmoothQuant-W8A8-INT8 \
